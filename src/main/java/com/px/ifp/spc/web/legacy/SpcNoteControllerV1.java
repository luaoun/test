 ...
 * @Date: 2024-07-10
 */
@Tag(name = "SPC标注相关接口(V1-Legacy)")
@RestController
@RequestMapping("/api/v1/spcNote")
public class SpcNoteControllerV1 extends BaseController {

    @Autowired
    private com.px.ifp.spc.web.manage.note.SpcNoteController spcNoteController;
